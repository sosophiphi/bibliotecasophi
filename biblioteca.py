...
livros_db = [
    ...
    [7, "Cem Anos de Solidão", "Gabriel García Márquez", "Realismo Mágico", "Record", "Disponível", None],
    [8, "Mulheres que Correm com os Lobos", "Clarissa Pinkola Estés", "Psicologia/Feminismo", "Rocco", "Disponível", None],
    [9, "O Guia do Mochileiro das Galáxias", "Douglas Adams", "Ficção Científica", "Aleph", "Alugado", "soso a melhor"]
]
...
class App(ctk.CTk):
    ...
    def exibir_cliente(self):
        ...
        self.entry_busca = ctk.CTkEntry(frame_filtro, width=200)
        ...
        ctk.CTkButton(frame_filtro, text="Todos", command=lambda: self.atualizar_tabela(limpar_busca=True)).pack(side="left", padx=10, pady=10)

   
        self.tabela_livros = ctk.CTkScrollableFrame(self)
        self.tabela_livros.grid(row=2, column=0, padx=20, pady=10, sticky="nsew")
        self.tabela_livros.columnconfigure(0, weight=1) 
